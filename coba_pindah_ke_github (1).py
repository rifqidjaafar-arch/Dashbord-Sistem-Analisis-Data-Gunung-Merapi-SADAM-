# -*- coding: utf-8 -*-
"""coba pindah ke github

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bdrOP08p9-oqNYxboeEgyjl2BLPS8-T9
"""
...
print(f"Library Siap Digunakan! | Last Check: {datetime.now().strftime('%H:%M:%S')}")
